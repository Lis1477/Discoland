...
<!--    <link rel="stylesheet" href="{{ asset('css/owl.carousel.css') }}"> -->
    <link rel="stylesheet" href="{{ asset('css/tmpl_style.css') }}">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    <div class="user-menu">
                        <ul>
                            <li><a href="#"><i class="fa fa-heart"> </i>Лист желаний</a></li>
                            <li class="dropdown">
                                <a data-toggle="dropdown" href="#"><i class="fa fa-user"> </i>Мой аккаунт<b class="caret"></b></a>
                    ...
                    <div class="header-right">
                        <ul class="list-unstyled list-inline">
                            <li class="dropdown dropdown-small">
                                <a data-toggle="dropdown" data-hover="dropdown" class="dropdown-toggle" href="#"><span class="key">валюта :</span><span class="value">BYN </span><b class="caret"></b></a>
